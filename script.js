...
document.querySelector(".Enroll1").addEventListener("click", () => {
    ...
    p.innerText = "Registering in Level 1 Medium Voltage Course"
    ...
    function whatsapp() {
        ...
        let message = `Enrolling in Level 1 Medium Voltage Course\nName: ${name}\nAge: ${age}\nGraduation Year: ${graduationYear}\nSpecialization: ${specialization}\nJob: ${job}`;
...
document.querySelector(".Enroll2").addEventListener("click", () => {
    ...
    h2.innerText = "Registration"
    let p = document.createElement("p")
    p.innerText = "Registering in Level 2 Medium Voltage Course"
    let Form = document.createElement("form")
    let inp1 = document.createElement("input")
    inp1.placeholder = "Full Name"
    inp1.id = "name"
    ...
    function whatsapp() {
        ...
        let specialization = document.getElementById("specialization").value;
        let job = document.getElementById("job").value;
        let message = `Enrolling in Level 2 Medium Voltage Course\nName: ${name}\nAge: ${age}\nGraduation Year: ${graduationYear}\nSpecialization: ${specialization}\nJob: ${job}`;
        window.open(`https://api.whatsapp.com/send?phone=+201274087211&text=${encodeURIComponent(message)}`);
    }
